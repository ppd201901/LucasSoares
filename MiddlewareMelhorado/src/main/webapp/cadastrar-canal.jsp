...
<html>
    ...
    <body>
        ...
        <h2> <a href="index.jsp"> < voltar</a>   <br>       <a href="cadastrar-canal.jsp"> [Refresh Painel de Canais ]</a></h2>
            ...
            if (listCanal == null || (listCanal.size() == 0)) {
                ...
                for (int i = 0; i < listCanal.size(); i++) {
                    ...
                    if (!listCanal.get(i).isAtivo()) {
                        ...
                        out.println(" <h3> Aplicações Escritoras: ");
                        
                        List<Aplicacao> appsEscrita = listCanal.get(i).getAppsEscritores();
                        
                        if (appsEscrita != null) {

                        	Iterator<Aplicacao> it = appsEscrita.iterator();
                        	
                        	while(it.hasNext()){
                        		out.println(it.next().getNome());
                        	}
                        ...
                        out.println(" <h3> Aplicações Leitoras: ");

                        List<Aplicacao> appsLeitura = listCanal.get(i).getAppsLeitores();
                        
                        if (appsLeitura != null) {

                        	Iterator<Aplicacao> it = appsLeitura.iterator();
